...
function setup() {
  ...
  const modelInfo = {
    model: '/static/asanas/modeltrain/modeltrain.json',
    metadata: '/static/asanas/modeltrain/model_metatrain.json',
    weights: '/static/asanas/modeltrain/model.weightstrain.bin',
  };
